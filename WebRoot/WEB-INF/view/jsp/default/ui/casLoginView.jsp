                ...
                <!-- <spring:message code="screen.welcome.welcome" /> -->
                    ...
                    <div class="row fl-controls-left">
                        ...
                        <span style="display: block;float:left;width:60px;height:25px;float:left;">
                         ...
                         <span style="display:block;width:60px;height:100%;float:left;vertical-align:middle; display: table-cell;margin-left:15px;"><spring:message code="screen.welcome.label.refresh" /></span>
                        </a>
